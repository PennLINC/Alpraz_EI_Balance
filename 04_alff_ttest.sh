...
while IFS=, read subid sesid day series group form drug other; do
	...
	mkdir -p dataDir
	orgDir="/cbica/projects/alpraz_EI/data/${datadirname}/xcpengine/sub-0${subid}/ses-00${sesid}/task-emotionid/space-MNI152NLin2009cAsym/alff/"
	...
	if [ $(ls /cbica/projects/alpraz_EI//data/${datadirname}/xcpengine/sub-0${subid}/ses-00*/task-emotionid/space-MNI152NLin2009cAsym/alff/sub*_task-emotionid_space-MNI152NLin2009cAsym_${measure}.nii.gz|wc -l) -lt 2 ];
	then 
